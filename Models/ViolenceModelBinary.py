...
early_stopper = tf.keras.callbacks.EarlyStopping(
    "val_accuracy", patience=20, restore_best_weights=True
)
reduce_lr_on_plataeu = tf.keras.callbacks.ReduceLROnPlateau(
    monitor="val_accuracy", factor=0.2, patience=10
)
...
check_point = tf.keras.callbacks.ModelCheckpoint(
    f"Checkpoints/violence_model_{time_date}.h5", save_best_only=True
)
