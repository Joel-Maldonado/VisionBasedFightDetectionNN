...
VIOLENCE_MODEL = tf.keras.models.load_model('./ViolenceModel_EvalAcc_0.9633333086967468.h5')
# BOX_MODEL = tf.keras.models.load_model('./PersonDetection_loss_0.063988097012043.h5')

VIDEO_PATH = '/u/jruiz_intern/Desktop/jruiz/Datasets/RWF-2000/val/Fight/nuf-d5GugL0_7.avi'
